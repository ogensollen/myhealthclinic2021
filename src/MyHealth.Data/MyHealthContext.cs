...
namespace MyHealth.Data
{
    public class MyHealthContext : IdentityDbContext<ApplicationUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ClinicAppointment>().Property(a => a.AppointmentId).UseIdentityColumn();
            ...
            builder.Entity<HomeAppointment>().Property(a => a.AppointmentId).UseIdentityColumn();
            ...
            builder.Entity<Doctor>().Property(d => d.DoctorId).UseIdentityColumn();
            builder.Entity<Patient>().Property(p => p.PatientId).UseIdentityColumn();
